<?php include_once "common.php";
	...
	$row_adjustment = 40;
?>
<body style="margin:0px;" onfocus="window.close();">
	...
	?>
	<div style="font-size:<?=$fontsize;?>px;position:absolute;top:<?=$row_adjustment+330;?>px;left:25px;width:450px;"><?=$client;?></div>
	<div style="font-size:<?=$fontsize;?>px;position:absolute;top:<?=$row_adjustment+340;?>px;left:720px;"><?=format_tanggal($invoice["issue_at"],"dFY");?></div>
	<div style="font-size:<?=$fontsize;?>px;position:absolute;top:<?=$row_adjustment+390;?>px;left:720px;"><?=$invoice["num"];?></div>
	<div style="font-size:<?=$fontsize;?>px;position:absolute;top:<?=$row_adjustment+430;?>px;left:720px;"><?=$invoice["due_date"];?></div>
	<?php 
		//$top_detail = 570+$row_adjustment;
		$top_detail = 540+$row_adjustment;
		$rowspace = 18;
                $fontsize = 18;
	...
	<?php
		...
		if($invoice["tax23"] != 0){
			$top_detail += $rowspace;
			if($top_detail > 915) $top_detail = 915;
	?>
			<?php 
				if(!$tax_rate_wrote){ 
					$top_detail += $rowspace;
	...
	?>
	<div style="font-size:<?=$fontsize;?>px;position:absolute;top:<?=$row_adjustment+960;?>px;left:560px;text-align: right;width:200px;"><b><?=$currency_id;?></b></div>
	<div style="font-size:<?=$fontsize;?>px;position:absolute;top:<?=$row_adjustment+960;?>px;left:730px;text-align: right;width:200px;"><b><?=format_amount($invoice["total"],$decimalnum);?></b></div>
	<div style="font-size:<?=$fontsize;?>px;position:absolute;width:85%;height:70px;top:<?=$row_adjustment+1052;?>px;left:20px;vertical-align: middle;text-align:center;">
