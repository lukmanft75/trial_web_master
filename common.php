<?php
	...
	$__coa["Piutang Usaha"]		= "130-00";
	$__coa["Hutang PPN"]		= "220-01";
	$__coa["BDD PPh23"]			= "160-03";
	...
	if($db->fetch_single_data("users","forbidden_chr_dashboards",["id" => $__user_id]) > 0) exit();
