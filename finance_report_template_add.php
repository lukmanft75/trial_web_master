...
<div class="bo_title">Add Finance Report Template</div>
<?php
	if(isset($_POST["save"])){
		...
		if($inserting["affected_rows"] >= 0){
			$finance_report_template_id = $inserting["insert_id"];
			...
			javascript("window.location='finance_report_template_edit.php?id=".$finance_report_template_id."';");
		} else {
